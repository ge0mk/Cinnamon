...
@__constant_128x1xf32 = private constant [128 x [1 x float]] zeroinitializer, align 64
...
@__constant_1xi64_1 = private constant [1 x i64] [i64 48], align 64
@__constant_16x3xf32 = private constant [16 x [3 x float]] zeroinitializer, align 64
@__constant_2xi64_1 = private constant [2 x i64] [i64 16, i64 3], align 64
@__constant_48xf32 = private constant [48 x float] zeroinitializer, align 64
@__constant_1xi64_0 = private constant [1 x i64] [i64 256], align 64
@__constant_128x2xf32 = private constant [128 x [2 x float]] zeroinitializer, align 64
@__constant_2xi64_0 = private constant [2 x i64] [i64 128, i64 2], align 64
@__constant_256xf32 = private constant [256 x float] zeroinitializer, align 64
@__constant_xf32_0 = private constant float 0xFFF0000000000000, align 64
@__constant_xf32 = private constant float 0.000000e+00, align 64
@__constant_1xi64 = private constant [1 x i64] [i64 288], align 64
@__constant_96x3xf32 = private constant [96 x [3 x float]] zeroinitializer, align 64
@__constant_2xi64 = private constant [2 x i64] [i64 96, i64 3], align 64
...
@dpu_program_11 = private constant [8 x i8] c"attn_10\00"
@dpu_program_12 = private constant [5 x i8] c"attn\00"
@dpu_program_13 = private constant [7 x i8] c"attn_9\00"
@dpu_program_14 = private constant [5 x i8] c"attn\00"
...
declare void @upmemrt_dpu_gather(ptr, ptr, i64, i64, i64, ptr)
...
declare void @upmemrt_dpu_scatter(ptr, ptr, i64, i64, i64, ptr)
...
361:                                              ; preds = %351
  ...
  call void @upmemrt_dpu_scatter(ptr %350, ptr %362, i64 55296, i64 1152, i64 1160, ptr @scatter_map)
  call void @upmemrt_dpu_scatter(ptr %350, ptr %66, i64 1152, i64 1152, i64 8, ptr @scatter_map_0)
  call void @upmemrt_dpu_scatter(ptr %350, ptr @__constant_48x1xf32, i64 192, i64 8, i64 0, ptr @scatter_map_1)
  call void @upmemrt_dpu_launch(ptr %350)
  call void @upmemrt_dpu_gather(ptr %350, ptr %72, i64 192, i64 8, i64 0, ptr @scatter_map_1)
...
407:                                              ; preds = %397
  ...
  call void @upmemrt_dpu_scatter(ptr %396, ptr %408, i64 55296, i64 1152, i64 1160, ptr @scatter_map)
  call void @upmemrt_dpu_scatter(ptr %396, ptr %97, i64 1152, i64 1152, i64 8, ptr @scatter_map_0)
  call void @upmemrt_dpu_scatter(ptr %396, ptr @__constant_48x1xf32, i64 192, i64 8, i64 0, ptr @scatter_map_1)
  call void @upmemrt_dpu_launch(ptr %396)
  call void @upmemrt_dpu_gather(ptr %396, ptr %103, i64 192, i64 8, i64 0, ptr @scatter_map_1)
...
453:                                              ; preds = %443
  ...
  call void @upmemrt_dpu_scatter(ptr %442, ptr %454, i64 55296, i64 1152, i64 1160, ptr @scatter_map)
  call void @upmemrt_dpu_scatter(ptr %442, ptr %128, i64 1152, i64 1152, i64 8, ptr @scatter_map_0)
  call void @upmemrt_dpu_scatter(ptr %442, ptr @__constant_48x1xf32, i64 192, i64 8, i64 0, ptr @scatter_map_1)
  call void @upmemrt_dpu_launch(ptr %442)
  call void @upmemrt_dpu_gather(ptr %442, ptr %134, i64 192, i64 8, i64 0, ptr @scatter_map_1)
...
578:                                              ; preds = %568
  ...
  call void @upmemrt_dpu_scatter(ptr %567, ptr %579, i64 55296, i64 1152, i64 1160, ptr @scatter_map)
  call void @upmemrt_dpu_scatter(ptr %567, ptr %199, i64 1152, i64 1152, i64 8, ptr @scatter_map_0)
  call void @upmemrt_dpu_scatter(ptr %567, ptr @__constant_48x1xf32, i64 192, i64 8, i64 0, ptr @scatter_map_1)
  call void @upmemrt_dpu_launch(ptr %567)
  call void @upmemrt_dpu_gather(ptr %567, ptr %205, i64 192, i64 8, i64 0, ptr @scatter_map_1)
...
603:                                              ; preds = %559
  ...
  call void @upmemrt_dpu_scatter(ptr %605, ptr %337, i64 1152, i64 24, i64 48, ptr @scatter_map_2)
  call void @upmemrt_dpu_scatter(ptr %605, ptr %604, i64 1152, i64 24, i64 24, ptr @scatter_map_2)
  call void @upmemrt_dpu_scatter(ptr %605, ptr @__constant_48x6xf32, i64 1152, i64 24, i64 0, ptr @scatter_map_2)
  call void @upmemrt_dpu_launch(ptr %605)
  call void @upmemrt_dpu_gather(ptr %605, ptr %211, i64 1152, i64 24, i64 0, ptr @scatter_map_2)
...
627:                                              ; preds = %617
  ...
  call void @upmemrt_dpu_scatter(ptr %616, ptr %628, i64 55296, i64 1152, i64 1160, ptr @scatter_map)
  call void @upmemrt_dpu_scatter(ptr %616, ptr %248, i64 1152, i64 1152, i64 8, ptr @scatter_map_0)
  call void @upmemrt_dpu_scatter(ptr %616, ptr @__constant_48x1xf32, i64 192, i64 8, i64 0, ptr @scatter_map_1)
  call void @upmemrt_dpu_launch(ptr %616)
  call void @upmemrt_dpu_gather(ptr %616, ptr %254, i64 192, i64 8, i64 0, ptr @scatter_map_1)
...
673:                                              ; preds = %663
  ...
  call void @upmemrt_dpu_scatter(ptr %662, ptr %674, i64 55296, i64 1152, i64 1160, ptr @scatter_map)
  call void @upmemrt_dpu_scatter(ptr %662, ptr %279, i64 1152, i64 1152, i64 8, ptr @scatter_map_0)
  call void @upmemrt_dpu_scatter(ptr %662, ptr @__constant_48x1xf32, i64 192, i64 8, i64 0, ptr @scatter_map_1)
  call void @upmemrt_dpu_launch(ptr %662)
  call void @upmemrt_dpu_gather(ptr %662, ptr %285, i64 192, i64 8, i64 0, ptr @scatter_map_1)
...
753:                                              ; preds = %743
  ...
  call void @upmemrt_dpu_scatter(ptr %742, ptr %754, i64 147456, i64 3072, i64 3080, ptr @scatter_map_3)
  call void @upmemrt_dpu_scatter(ptr %742, ptr %321, i64 3072, i64 3072, i64 8, ptr @scatter_map_0)
  call void @upmemrt_dpu_scatter(ptr %742, ptr @__constant_48x1xf32, i64 192, i64 8, i64 0, ptr @scatter_map_1)
  call void @upmemrt_dpu_launch(ptr %742)
  call void @upmemrt_dpu_gather(ptr %742, ptr %327, i64 192, i64 8, i64 0, ptr @scatter_map_1)
...
778:                                              ; preds = %734
  ...
  call void @upmemrt_dpu_scatter(ptr %780, ptr %337, i64 1152, i64 24, i64 48, ptr @scatter_map_2)
  call void @upmemrt_dpu_scatter(ptr %780, ptr %779, i64 1152, i64 24, i64 24, ptr @scatter_map_2)
  call void @upmemrt_dpu_scatter(ptr %780, ptr @__constant_48x6xf32, i64 1152, i64 24, i64 0, ptr @scatter_map_2)
  ...
  call void @upmemrt_dpu_gather(ptr %780, ptr %786, i64 1152, i64 24, i64 0, ptr @scatter_map_2)
...
833:                                              ; preds = %819
  ...
  %859 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 128) to i64), i64 64))
...
869:                                              ; preds = %865
  %870 = mul i64 %866, 288
  %871 = call ptr @upmemrt_dpu_alloc(i32 1, i32 8, ptr @dpu_program_8)
  br label %872
...
882:                                              ; preds = %872
  ...
  call void @upmemrt_dpu_scatter(ptr %871, ptr %883, i64 147456, i64 1152, i64 1160, ptr @scatter_map_4)
  call void @upmemrt_dpu_scatter(ptr %871, ptr %858, i64 1152, i64 1152, i64 8, ptr @scatter_map_0)
  call void @upmemrt_dpu_scatter(ptr %871, ptr @__constant_128x1xf32, i64 512, i64 8, i64 0, ptr @scatter_map_5)
  call void @upmemrt_dpu_launch(ptr %871)
  call void @upmemrt_dpu_gather(ptr %871, ptr %864, i64 512, i64 8, i64 0, ptr @scatter_map_5)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr %905, ptr %864, i64 mul (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i64 128), i1 false)
  %906 = add i64 %866, 128
  br label %865
...
63:                                               ; preds = %59
  ...
  call void @upmemrt_dpu_scatter(ptr %65, ptr %0, i64 192, i64 16, i64 32, ptr @scatter_map_6)
  ...
  call void @upmemrt_dpu_scatter(ptr %65, ptr %34, i64 192, i64 16, i64 16, ptr @scatter_map_6)
  call void @upmemrt_dpu_scatter(ptr %65, ptr @__constant_16x3xf32, i64 192, i64 16, i64 0, ptr @scatter_map_6)
  call void @upmemrt_dpu_launch(ptr %65)
  call void @upmemrt_dpu_gather(ptr %65, ptr %40, i64 192, i64 16, i64 0, ptr @scatter_map_6)
  call void @upmemrt_dpu_free(ptr %65)
  call void @llvm.memcpy.p0.p0.i64(ptr %52, ptr @__constant_xf32, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i1 false)
  br label %67
...
76:                                               ; preds = %67
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr %58, ptr @__constant_xf32, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i1 false)
...
102:                                              ; preds = %59
  ...
  %139 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i64 64))
...
151:                                              ; preds = %155, %102
  %152 = phi i64 [ %175, %155 ], [ 0, %102 ]
  %153 = phi { ptr, ptr, i64, [1 x i64], [1 x i64] } [ %174, %155 ], [ %132, %102 ]
...
155:                                              ; preds = %151
  ...
  call void @upmemrt_dpu_scatter(ptr %159, ptr %138, i64 192, i64 16, i64 24, ptr @scatter_map_6)
  %161 = getelementptr float, ptr %144, i64 0
  store float %158, ptr %161, align 4
  call void @upmemrt_dpu_scatter(ptr %159, ptr %144, i64 4, i64 8, i64 16, ptr @scatter_map_0)
  call void @upmemrt_dpu_scatter(ptr %159, ptr @__constant_16x3xf32, i64 192, i64 16, i64 0, ptr @scatter_map_6)
  call void @upmemrt_dpu_launch(ptr %159)
  call void @upmemrt_dpu_gather(ptr %159, ptr %150, i64 192, i64 16, i64 0, ptr @scatter_map_6)
  call void @upmemrt_dpu_free(ptr %159)
  %162 = call ptr @upmemrt_dpu_alloc(i32 1, i32 1, ptr @dpu_program_11)
  call void @upmemrt_dpu_scatter(ptr %162, ptr %150, i64 192, i64 16, i64 32, ptr @scatter_map_6)
  %163 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %153, 1
  call void @upmemrt_dpu_scatter(ptr %162, ptr %163, i64 192, i64 16, i64 16, ptr @scatter_map_6)
  call void @upmemrt_dpu_scatter(ptr %162, ptr @__constant_16x3xf32, i64 192, i64 16, i64 0, ptr @scatter_map_6)
  call void @upmemrt_dpu_launch(ptr %162)
  %164 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 48) to i64), i64 64))
  %165 = ptrtoint ptr %164 to i64
  %166 = add i64 %165, 63
  %167 = urem i64 %166, 64
  %168 = sub i64 %166, %167
  %169 = inttoptr i64 %168 to ptr
  call void @upmemrt_dpu_gather(ptr %162, ptr %169, i64 192, i64 16, i64 0, ptr @scatter_map_6)
  %170 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } undef, ptr %164, 0
  %171 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %170, ptr %169, 1
  %172 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %171, i64 0, 2
  %173 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %172, i64 48, 3, 0
  %174 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %173, i64 1, 4, 0
  call void @upmemrt_dpu_free(ptr %162)
  %175 = add i64 %152, 1
  br label %151

176:                                              ; preds = %151
  %177 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %153, 0
  ret ptr %177
}

define ptr @rmsnorm(ptr %0, ptr %1) {
  %3 = call ptr @upmemrt_dpu_alloc(i32 1, i32 6, ptr @dpu_program_12)
  call void @upmemrt_dpu_scatter(ptr %3, ptr %0, i64 1152, i64 16, i64 32, ptr @scatter_map_7)
  call void @upmemrt_dpu_scatter(ptr %3, ptr %0, i64 1152, i64 16, i64 16, ptr @scatter_map_7)
  call void @upmemrt_dpu_scatter(ptr %3, ptr @__constant_96x3xf32, i64 1152, i64 16, i64 0, ptr @scatter_map_7)
  ...
  call void @upmemrt_dpu_gather(ptr %3, ptr %9, i64 1152, i64 16, i64 0, ptr @scatter_map_7)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr %21, ptr @__constant_xf32, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i1 false)
  br label %22
...
31:                                               ; preds = %22
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr %38, ptr @__constant_xf32, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i1 false)
  ...
  %47 = call ptr @upmemrt_dpu_alloc(i32 1, i32 6, ptr @dpu_program_13)
  call void @upmemrt_dpu_scatter(ptr %47, ptr %0, i64 1152, i64 16, i64 24, ptr @scatter_map_7)
  %48 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i64 64))
  %49 = ptrtoint ptr %48 to i64
  %50 = add i64 %49, 63
  %51 = urem i64 %50, 64
  %52 = sub i64 %50, %51
  %53 = inttoptr i64 %52 to ptr
  %54 = getelementptr float, ptr %53, i64 0
  store float %46, ptr %54, align 4
  call void @upmemrt_dpu_scatter(ptr %47, ptr %53, i64 4, i64 8, i64 16, ptr @scatter_map_0)
  call void @upmemrt_dpu_scatter(ptr %47, ptr @__constant_96x3xf32, i64 1152, i64 16, i64 0, ptr @scatter_map_7)
  call void @upmemrt_dpu_launch(ptr %47)
  %55 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 288) to i64), i64 64))
  %56 = ptrtoint ptr %55 to i64
  %57 = add i64 %56, 63
  %58 = urem i64 %57, 64
  %59 = sub i64 %57, %58
  %60 = inttoptr i64 %59 to ptr
  call void @upmemrt_dpu_gather(ptr %47, ptr %60, i64 1152, i64 16, i64 0, ptr @scatter_map_7)
  call void @upmemrt_dpu_free(ptr %47)
  %61 = call ptr @upmemrt_dpu_alloc(i32 1, i32 6, ptr @dpu_program_14)
  call void @upmemrt_dpu_scatter(ptr %61, ptr %60, i64 1152, i64 16, i64 32, ptr @scatter_map_7)
  call void @upmemrt_dpu_scatter(ptr %61, ptr %1, i64 1152, i64 16, i64 16, ptr @scatter_map_7)
  call void @upmemrt_dpu_scatter(ptr %61, ptr @__constant_96x3xf32, i64 1152, i64 16, i64 0, ptr @scatter_map_7)
  call void @upmemrt_dpu_launch(ptr %61)
  %62 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 288) to i64), i64 64))
  %63 = ptrtoint ptr %62 to i64
  %64 = add i64 %63, 63
  %65 = urem i64 %64, 64
  %66 = sub i64 %64, %65
  %67 = inttoptr i64 %66 to ptr
  call void @upmemrt_dpu_gather(ptr %61, ptr %67, i64 1152, i64 16, i64 0, ptr @scatter_map_7)
...
define ptr @softmax(ptr %0) {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr %13, ptr @__constant_xf32_0, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i1 false)
  br label %14
...
23:                                               ; preds = %14
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr %30, ptr @__constant_xf32_0, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i1 false)
  ...
  call void @upmemrt_dpu_scatter(ptr %35, ptr %0, i64 1024, i64 8, i64 16, ptr @scatter_map_8)
  ...
  %40 = sub i64 %38, %39
  %41 = inttoptr i64 %40 to ptr
  %42 = getelementptr float, ptr %41, i64 0
  store float %34, ptr %42, align 4
  call void @upmemrt_dpu_scatter(ptr %35, ptr %41, i64 4, i64 8, i64 8, ptr @scatter_map_0)
  call void @upmemrt_dpu_scatter(ptr %35, ptr @__constant_128x2xf32, i64 1024, i64 8, i64 0, ptr @scatter_map_8)
  call void @upmemrt_dpu_launch(ptr %35)
  %43 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 256) to i64), i64 64))
  %44 = ptrtoint ptr %43 to i64
  %45 = add i64 %44, 63
  %46 = urem i64 %45, 64
  %47 = sub i64 %45, %46
  %48 = inttoptr i64 %47 to ptr
  call void @upmemrt_dpu_gather(ptr %35, ptr %48, i64 1024, i64 8, i64 0, ptr @scatter_map_8)
  call void @upmemrt_dpu_free(ptr %35)
  %49 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 256) to i64), i64 64))
...
55:                                               ; preds = %58, %23
  %56 = phi i64 [ %63, %58 ], [ 0, %23 ]
  %57 = icmp slt i64 %56, 256
  br i1 %57, label %58, label %64

58:                                               ; preds = %55
  %59 = getelementptr float, ptr %48, i64 %56
...
64:                                               ; preds = %55
  %65 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i64 64))
  %66 = ptrtoint ptr %65 to i64
  %67 = add i64 %66, 63
  %68 = urem i64 %67, 64
  %69 = sub i64 %67, %68
  %70 = inttoptr i64 %69 to ptr
  %71 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i64 64))
  %72 = ptrtoint ptr %71 to i64
  %73 = add i64 %72, 63
  %74 = urem i64 %73, 64
  %75 = sub i64 %73, %74
  %76 = inttoptr i64 %75 to ptr
  call void @llvm.memcpy.p0.p0.i64(ptr %76, ptr @__constant_xf32, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i1 false)
  br label %77

77:                                               ; preds = %80, %64
  %78 = phi i64 [ %85, %80 ], [ 0, %64 ]
  %79 = icmp slt i64 %78, 256
  br i1 %79, label %80, label %86

80:                                               ; preds = %77
  %81 = getelementptr float, ptr %54, i64 %78
  %82 = load float, ptr %81, align 4
  %83 = load float, ptr %76, align 4
  %84 = fadd float %82, %83
...
86:                                               ; preds = %77
  %87 = load float, ptr %76, align 4
  store float %87, ptr %70, align 4
  %88 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i64 64))
  %89 = ptrtoint ptr %88 to i64
  %90 = add i64 %89, 63
  %91 = urem i64 %90, 64
  %92 = sub i64 %90, %91
  %93 = inttoptr i64 %92 to ptr
  call void @llvm.memcpy.p0.p0.i64(ptr %93, ptr @__constant_xf32, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i1 false)
  %94 = load float, ptr %70, align 4
  %95 = load float, ptr %93, align 4
  %96 = fadd float %94, %95
  store float %96, ptr %93, align 4
  %97 = load float, ptr %93, align 4
  %98 = call ptr @upmemrt_dpu_alloc(i32 1, i32 8, ptr @dpu_program_16)
  call void @upmemrt_dpu_scatter(ptr %98, ptr %54, i64 1024, i64 8, i64 16, ptr @scatter_map_8)
  %99 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1) to i64), i64 64))
  ...
  call void @upmemrt_dpu_scatter(ptr %98, ptr %104, i64 4, i64 8, i64 8, ptr @scatter_map_0)
  call void @upmemrt_dpu_scatter(ptr %98, ptr @__constant_128x2xf32, i64 1024, i64 8, i64 0, ptr @scatter_map_8)
  call void @upmemrt_dpu_launch(ptr %98)
  %106 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (float, ptr null, i32 256) to i64), i64 64))
  %107 = ptrtoint ptr %106 to i64
  %108 = add i64 %107, 63
  %109 = urem i64 %108, 64
  %110 = sub i64 %108, %109
  %111 = inttoptr i64 %110 to ptr
  call void @upmemrt_dpu_gather(ptr %98, ptr %111, i64 1024, i64 8, i64 0, ptr @scatter_map_8)
  call void @upmemrt_dpu_free(ptr %98)
  ret ptr %106
}
