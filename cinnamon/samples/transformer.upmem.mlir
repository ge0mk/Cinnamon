...
module {
  ...
  memref.global "private" constant @__constant_128x1xf32 : memref<128x1xf32> = dense<0.000000e+00> {alignment = 64 : i64}
  ...
  memref.global "private" constant @__constant_1xi64_1 : memref<1xi64> = dense<48> {alignment = 64 : i64}
  memref.global "private" constant @__constant_16x3xf32 : memref<16x3xf32> = dense<0.000000e+00> {alignment = 64 : i64}
  memref.global "private" constant @__constant_2xi64_1 : memref<2xi64> = dense<[16, 3]> {alignment = 64 : i64}
  memref.global "private" constant @__constant_48xf32 : memref<48xf32> = dense<0.000000e+00> {alignment = 64 : i64}
  memref.global "private" constant @__constant_1xi64_0 : memref<1xi64> = dense<256> {alignment = 64 : i64}
  memref.global "private" constant @__constant_128x2xf32 : memref<128x2xf32> = dense<0.000000e+00> {alignment = 64 : i64}
  memref.global "private" constant @__constant_2xi64_0 : memref<2xi64> = dense<[128, 2]> {alignment = 64 : i64}
  memref.global "private" constant @__constant_256xf32 : memref<256xf32> = dense<0.000000e+00> {alignment = 64 : i64}
  memref.global "private" constant @__constant_xf32_0 : memref<f32> = dense<0xFF800000> {alignment = 64 : i64}
  memref.global "private" constant @__constant_xf32 : memref<f32> = dense<0.000000e+00> {alignment = 64 : i64}
  memref.global "private" constant @__constant_1xi64 : memref<1xi64> = dense<288> {alignment = 64 : i64}
  memref.global "private" constant @__constant_96x3xf32 : memref<96x3xf32> = dense<0.000000e+00> {alignment = 64 : i64}
  memref.global "private" constant @__constant_2xi64 : memref<2xi64> = dense<[96, 3]> {alignment = 64 : i64}
  ...
  func.func @forward(%arg0: index, %arg1: index, %arg2: memref<6x256x288xf32>, %arg3: memref<6x256x288xf32>, %arg4: memref<32000x288xf32>, %arg5: memref<6x288xf32>, %arg6: memref<6x288x288xf32>, %arg7: memref<6x288x288xf32>, %arg8: memref<6x288x288xf32>, %arg9: memref<6x288x288xf32>, %arg10: memref<6x768x288xf32>, %arg11: memref<6x288x768xf32>, %arg12: memref<6x768x288xf32>, %arg13: memref<6x288xf32>, %arg14: memref<288xf32>, %arg15: memref<32000x288xf32>) -> memref<32000xf32> {
    ...
    %0 = scf.for %arg16 = %c0 to %c6 step %c1 iter_args(%arg17 = %alloc) -> (memref<288xf32>) {
      ...
      %7 = scf.for %arg18 = %c0 to %c288 step %c48 iter_args(%arg19 = %alloc_6) -> (memref<288x1xf32>) {
        ...
        upmem.scatter %subview_82[1160, 288, #map] onto %28 : memref<48x288xf32, strided<[288, 1], offset: ?>> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %alloc_7[8, 288, #map1] onto %28 : memref<1x288xf32> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %27[0, 1, #map2] onto %28 : memref<48x1xf32> onto !upmem.hierarchy<1x6x8>
        upmem.launch_func  @dpu_kernels::@forward %28 : !upmem.hierarchy<1x6x8> 
        upmem.gather %alloc_8[0, 1, #map2] from %28 : memref<48x1xf32> from !upmem.hierarchy<1x6x8>
      ...
      %9 = scf.for %arg18 = %c0 to %c288 step %c48 iter_args(%arg19 = %alloc_10) -> (memref<288x1xf32>) {
        ...
        upmem.scatter %subview_82[1160, 288, #map] onto %28 : memref<48x288xf32, strided<[288, 1], offset: ?>> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %alloc_11[8, 288, #map1] onto %28 : memref<1x288xf32> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %27[0, 1, #map2] onto %28 : memref<48x1xf32> onto !upmem.hierarchy<1x6x8>
        upmem.launch_func  @dpu_kernels::@forward %28 : !upmem.hierarchy<1x6x8> 
        upmem.gather %alloc_12[0, 1, #map2] from %28 : memref<48x1xf32> from !upmem.hierarchy<1x6x8>
        upmem.free_dpus %28 : !upmem.hierarchy<1x6x8>
        %alloc_83 = memref.alloc() {alignment = 64 : i64} : memref<288x1xf32>
        memref.copy %arg19, %alloc_83 : memref<288x1xf32> to memref<288x1xf32>
        %subview_84 = memref.subview %alloc_83[%arg18, 0] [48, 1] [1, 1] : memref<288x1xf32> to memref<48x1xf32, strided<[1, 1], offset: ?>>
      ...
      %10 = scf.for %arg18 = %c0 to %c288 step %c48 iter_args(%arg19 = %alloc_14) -> (memref<288x1xf32>) {
        ...
        upmem.scatter %subview_82[1160, 288, #map] onto %28 : memref<48x288xf32, strided<[288, 1], offset: ?>> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %alloc_15[8, 288, #map1] onto %28 : memref<1x288xf32> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %27[0, 1, #map2] onto %28 : memref<48x1xf32> onto !upmem.hierarchy<1x6x8>
        upmem.launch_func  @dpu_kernels::@forward %28 : !upmem.hierarchy<1x6x8> 
        upmem.gather %alloc_16[0, 1, #map2] from %28 : memref<48x1xf32> from !upmem.hierarchy<1x6x8>
        upmem.free_dpus %28 : !upmem.hierarchy<1x6x8>
        %alloc_83 = memref.alloc() {alignment = 64 : i64} : memref<288x1xf32>
        memref.copy %arg19, %alloc_83 : memref<288x1xf32> to memref<288x1xf32>
        %subview_84 = memref.subview %alloc_83[%arg18, 0] [48, 1] [1, 1] : memref<288x1xf32> to memref<48x1xf32, strided<[1, 1], offset: ?>>
      ...
      %15 = scf.for %arg18 = %c0 to %c288 step %c48 iter_args(%arg19 = %alloc_23) -> (memref<288x1xf32>) {
        ...
        upmem.scatter %subview_82[1160, 288, #map] onto %28 : memref<48x288xf32, strided<[288, 1], offset: ?>> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %alloc_24[8, 288, #map1] onto %28 : memref<1x288xf32> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %27[0, 1, #map2] onto %28 : memref<48x1xf32> onto !upmem.hierarchy<1x6x8>
        upmem.launch_func  @dpu_kernels::@forward %28 : !upmem.hierarchy<1x6x8> 
        upmem.gather %alloc_25[0, 1, #map2] from %28 : memref<48x1xf32> from !upmem.hierarchy<1x6x8>
        upmem.free_dpus %28 : !upmem.hierarchy<1x6x8>
        %alloc_83 = memref.alloc() {alignment = 64 : i64} : memref<288x1xf32>
        memref.copy %arg19, %alloc_83 : memref<288x1xf32> to memref<288x1xf32>
        %subview_84 = memref.subview %alloc_83[%arg18, 0] [48, 1] [1, 1] : memref<288x1xf32> to memref<48x1xf32, strided<[1, 1], offset: ?>>
      ...
      upmem.scatter %reshape_67[48, 6, #map] onto %16 : memref<48x6xf32> onto !upmem.hierarchy<1x6x8>
      %reshape_68 = memref.reshape %reshape_66(%17) : (memref<288xf32>, memref<2xi64>) -> memref<48x6xf32>
      upmem.scatter %reshape_68[24, 6, #map] onto %16 : memref<48x6xf32> onto !upmem.hierarchy<1x6x8>
      %18 = memref.get_global @__constant_48x6xf32 : memref<48x6xf32>
      upmem.scatter %18[0, 6, #map] onto %16 : memref<48x6xf32> onto !upmem.hierarchy<1x6x8>
      upmem.launch_func  @dpu_kernels::@forward_3 %16 : !upmem.hierarchy<1x6x8> 
      upmem.gather %alloc_26[0, 6, #map] from %16 : memref<48x6xf32> from !upmem.hierarchy<1x6x8>
      ...
      %20 = scf.for %arg18 = %c0 to %c768 step %c48 iter_args(%arg19 = %alloc_30) -> (memref<768x1xf32>) {
        ...
        upmem.scatter %subview_82[1160, 288, #map] onto %28 : memref<48x288xf32, strided<[288, 1], offset: ?>> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %alloc_31[8, 288, #map1] onto %28 : memref<1x288xf32> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %27[0, 1, #map2] onto %28 : memref<48x1xf32> onto !upmem.hierarchy<1x6x8>
        upmem.launch_func  @dpu_kernels::@forward %28 : !upmem.hierarchy<1x6x8> 
        upmem.gather %alloc_32[0, 1, #map2] from %28 : memref<48x1xf32> from !upmem.hierarchy<1x6x8>
        upmem.free_dpus %28 : !upmem.hierarchy<1x6x8>
      ...
      %22 = scf.for %arg18 = %c0 to %c768 step %c48 iter_args(%arg19 = %alloc_34) -> (memref<768x1xf32>) {
        ...
        upmem.scatter %subview_82[1160, 288, #map] onto %28 : memref<48x288xf32, strided<[288, 1], offset: ?>> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %alloc_35[8, 288, #map1] onto %28 : memref<1x288xf32> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %27[0, 1, #map2] onto %28 : memref<48x1xf32> onto !upmem.hierarchy<1x6x8>
        upmem.launch_func  @dpu_kernels::@forward %28 : !upmem.hierarchy<1x6x8> 
        upmem.gather %alloc_36[0, 1, #map2] from %28 : memref<48x1xf32> from !upmem.hierarchy<1x6x8>
        upmem.free_dpus %28 : !upmem.hierarchy<1x6x8>
        %alloc_83 = memref.alloc() {alignment = 64 : i64} : memref<768x1xf32>
        memref.copy %arg19, %alloc_83 : memref<768x1xf32> to memref<768x1xf32>
        %subview_84 = memref.subview %alloc_83[%arg18, 0] [48, 1] [1, 1] : memref<768x1xf32> to memref<48x1xf32, strided<[1, 1], offset: ?>>
      ...
      %25 = scf.for %arg18 = %c0 to %c288 step %c48 iter_args(%arg19 = %alloc_39) -> (memref<288x1xf32>) {
        ...
        upmem.scatter %subview_82[3080, 768, #map] onto %28 : memref<48x768xf32, strided<[768, 1], offset: ?>> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %alloc_40[8, 768, #map1] onto %28 : memref<1x768xf32> onto !upmem.hierarchy<1x6x8>
        upmem.scatter %27[0, 1, #map2] onto %28 : memref<48x1xf32> onto !upmem.hierarchy<1x6x8>
        upmem.launch_func  @dpu_kernels::@forward_6 %28 : !upmem.hierarchy<1x6x8> 
        upmem.gather %alloc_41[0, 1, #map2] from %28 : memref<48x1xf32> from !upmem.hierarchy<1x6x8>
        upmem.free_dpus %28 : !upmem.hierarchy<1x6x8>
        %alloc_83 = memref.alloc() {alignment = 64 : i64} : memref<288x1xf32>
        memref.copy %arg19, %alloc_83 : memref<288x1xf32> to memref<288x1xf32>
        %subview_84 = memref.subview %alloc_83[%arg18, 0] [48, 1] [1, 1] : memref<288x1xf32> to memref<48x1xf32, strided<[1, 1], offset: ?>>
      ...
      upmem.scatter %reshape_67[48, 6, #map] onto %26 : memref<48x6xf32> onto !upmem.hierarchy<1x6x8>
      %reshape_79 = memref.reshape %reshape_78(%17) : (memref<288xf32>, memref<2xi64>) -> memref<48x6xf32>
      upmem.scatter %reshape_79[24, 6, #map] onto %26 : memref<48x6xf32> onto !upmem.hierarchy<1x6x8>
      upmem.scatter %18[0, 6, #map] onto %26 : memref<48x6xf32> onto !upmem.hierarchy<1x6x8>
      upmem.launch_func  @dpu_kernels::@forward_3 %26 : !upmem.hierarchy<1x6x8> 
      %alloc_80 = memref.alloc() {alignment = 64 : i64} : memref<48x6xf32>
      upmem.gather %alloc_80[0, 6, #map] from %26 : memref<48x6xf32> from !upmem.hierarchy<1x6x8>
    ...
    %alloc_49 = memref.alloc() {alignment = 64 : i64} : memref<128x1xf32>
    %3 = scf.for %arg16 = %c0 to %c32768 step %c128 iter_args(%arg17 = %alloc_47) -> (memref<32768x1xf32>) {
      %5 = memref.get_global @__constant_128x1xf32 : memref<128x1xf32>
      %subview_52 = memref.subview %alloc_44[%arg16, 0] [128, 288] [1, 1] : memref<32768x288xf32> to memref<128x288xf32, strided<[288, 1], offset: ?>>
      ...
      upmem.scatter %subview_52[1160, 288, #map3] onto %6 : memref<128x288xf32, strided<[288, 1], offset: ?>> onto !upmem.hierarchy<1x8x16>
      upmem.scatter %alloc_48[8, 288, #map1] onto %6 : memref<1x288xf32> onto !upmem.hierarchy<1x8x16>
      upmem.scatter %5[0, 1, #map4] onto %6 : memref<128x1xf32> onto !upmem.hierarchy<1x8x16>
      upmem.launch_func  @dpu_kernels::@forward_8 %6 : !upmem.hierarchy<1x8x16> 
      upmem.gather %alloc_49[0, 1, #map4] from %6 : memref<128x1xf32> from !upmem.hierarchy<1x8x16>
      ...
      %subview_54 = memref.subview %alloc_53[%arg16, 0] [128, 1] [1, 1] : memref<32768x1xf32> to memref<128x1xf32, strided<[1, 1], offset: ?>>
      memref.copy %alloc_49, %subview_54 : memref<128x1xf32> to memref<128x1xf32, strided<[1, 1], offset: ?>>
  ...
  func.func @attn(%arg0: memref<48xf32>, %arg1: memref<256x48xf32>, %arg2: memref<256x48xf32>, %arg3: index) -> memref<48xf32> {
    ...
    %alloc_3 = memref.alloc() {alignment = 64 : i64} : memref<16x3xf32>
    ...
    %0 = scf.for %arg4 = %c0 to %arg3 step %c1 iter_args(%arg5 = %alloc_1) -> (memref<256xf32>) {
      ...
      %3 = upmem.alloc_dpus : !upmem.hierarchy<1x1x16>
      %4 = memref.get_global @__constant_2xi64_1 : memref<2xi64>
      %reshape = memref.reshape %arg0(%4) : (memref<48xf32>, memref<2xi64>) -> memref<16x3xf32>
      upmem.scatter %reshape[32, 3, #map5] onto %3 : memref<16x3xf32> onto !upmem.hierarchy<1x1x16>
      memref.copy %subview, %alloc_2 : memref<48xf32, strided<[1], offset: ?>> to memref<48xf32>
      %reshape_13 = memref.reshape %alloc_2(%4) : (memref<48xf32>, memref<2xi64>) -> memref<16x3xf32>
      upmem.scatter %reshape_13[16, 3, #map5] onto %3 : memref<16x3xf32> onto !upmem.hierarchy<1x1x16>
      %5 = memref.get_global @__constant_16x3xf32 : memref<16x3xf32>
      upmem.scatter %5[0, 3, #map5] onto %3 : memref<16x3xf32> onto !upmem.hierarchy<1x1x16>
      upmem.launch_func  @dpu_kernels::@attn %3 : !upmem.hierarchy<1x1x16> 
      upmem.gather %alloc_3[0, 3, #map5] from %3 : memref<16x3xf32> from !upmem.hierarchy<1x1x16>
      %6 = memref.get_global @__constant_1xi64_1 : memref<1xi64>
      %reshape_14 = memref.reshape %alloc_3(%6) : (memref<16x3xf32>, memref<1xi64>) -> memref<48xf32>
      upmem.free_dpus %3 : !upmem.hierarchy<1x1x16>
      %7 = memref.get_global @__constant_xf32 : memref<f32>
    ...
    %alloc_11 = memref.alloc() {alignment = 64 : i64} : memref<1x1x1xf32>
    %alloc_12 = memref.alloc() {alignment = 64 : i64} : memref<16x3xf32>
    %2 = scf.for %arg4 = %c0 to %arg3 step %c1 iter_args(%arg5 = %alloc_9) -> (memref<48xf32>) {
      ...
      %4 = upmem.alloc_dpus : !upmem.hierarchy<1x1x16>
      %5 = memref.get_global @__constant_2xi64_1 : memref<2xi64>
      memref.copy %subview, %alloc_10 : memref<48xf32, strided<[1], offset: ?>> to memref<48xf32>
      %reshape = memref.reshape %alloc_10(%5) : (memref<48xf32>, memref<2xi64>) -> memref<16x3xf32>
      upmem.scatter %reshape[24, 3, #map5] onto %4 : memref<16x3xf32> onto !upmem.hierarchy<1x1x16>
      memref.store %3, %alloc_11[%c0, %c0, %c0] : memref<1x1x1xf32>
      upmem.scatter %alloc_11[16, 1, #map6] onto %4 : memref<1x1x1xf32> onto !upmem.hierarchy<1x1x16>
      %6 = memref.get_global @__constant_16x3xf32 : memref<16x3xf32>
      upmem.scatter %6[0, 3, #map5] onto %4 : memref<16x3xf32> onto !upmem.hierarchy<1x1x16>
      upmem.launch_func  @dpu_kernels::@attn_9 %4 : !upmem.hierarchy<1x1x16> 
      upmem.gather %alloc_12[0, 3, #map5] from %4 : memref<16x3xf32> from !upmem.hierarchy<1x1x16>
      %7 = memref.get_global @__constant_1xi64_1 : memref<1xi64>
      %reshape_13 = memref.reshape %alloc_12(%7) : (memref<16x3xf32>, memref<1xi64>) -> memref<48xf32>
      upmem.free_dpus %4 : !upmem.hierarchy<1x1x16>
      %8 = upmem.alloc_dpus : !upmem.hierarchy<1x1x16>
      %reshape_14 = memref.reshape %reshape_13(%5) : (memref<48xf32>, memref<2xi64>) -> memref<16x3xf32>
      upmem.scatter %reshape_14[32, 3, #map5] onto %8 : memref<16x3xf32> onto !upmem.hierarchy<1x1x16>
      %reshape_15 = memref.reshape %arg5(%5) : (memref<48xf32>, memref<2xi64>) -> memref<16x3xf32>
      upmem.scatter %reshape_15[16, 3, #map5] onto %8 : memref<16x3xf32> onto !upmem.hierarchy<1x1x16>
      upmem.scatter %6[0, 3, #map5] onto %8 : memref<16x3xf32> onto !upmem.hierarchy<1x1x16>
      upmem.launch_func  @dpu_kernels::@attn_10 %8 : !upmem.hierarchy<1x1x16> 
      %alloc_16 = memref.alloc() {alignment = 64 : i64} : memref<16x3xf32>
      upmem.gather %alloc_16[0, 3, #map5] from %8 : memref<16x3xf32> from !upmem.hierarchy<1x1x16>
      %reshape_17 = memref.reshape %alloc_16(%7) : (memref<16x3xf32>, memref<1xi64>) -> memref<48xf32>
      upmem.free_dpus %8 : !upmem.hierarchy<1x1x16>
  ...
  func.func @rmsnorm(%arg0: memref<288xf32>, %arg1: memref<288xf32>) -> memref<288xf32> {
    ...
    %0 = upmem.alloc_dpus : !upmem.hierarchy<1x6x16>
    %1 = memref.get_global @__constant_2xi64 : memref<2xi64>
    %reshape = memref.reshape %arg0(%1) : (memref<288xf32>, memref<2xi64>) -> memref<96x3xf32>
    upmem.scatter %reshape[32, 3, #map3] onto %0 : memref<96x3xf32> onto !upmem.hierarchy<1x6x16>
    upmem.scatter %reshape[16, 3, #map3] onto %0 : memref<96x3xf32> onto !upmem.hierarchy<1x6x16>
    %2 = memref.get_global @__constant_96x3xf32 : memref<96x3xf32>
    upmem.scatter %2[0, 3, #map3] onto %0 : memref<96x3xf32> onto !upmem.hierarchy<1x6x16>
    upmem.launch_func  @dpu_kernels::@attn %0 : !upmem.hierarchy<1x6x16> 
    %alloc = memref.alloc() {alignment = 64 : i64} : memref<96x3xf32>
    upmem.gather %alloc[0, 3, #map3] from %0 : memref<96x3xf32> from !upmem.hierarchy<1x6x16>
    %3 = memref.get_global @__constant_1xi64 : memref<1xi64>
    %reshape_1 = memref.reshape %alloc(%3) : (memref<96x3xf32>, memref<1xi64>) -> memref<288xf32>
    upmem.free_dpus %0 : !upmem.hierarchy<1x6x16>
    ...
    %15 = upmem.alloc_dpus : !upmem.hierarchy<1x6x16>
    upmem.scatter %reshape[24, 3, #map3] onto %15 : memref<96x3xf32> onto !upmem.hierarchy<1x6x16>
    %alloc_5 = memref.alloc() {alignment = 64 : i64} : memref<1x1x1xf32>
    memref.store %14, %alloc_5[%c0, %c0, %c0] : memref<1x1x1xf32>
    upmem.scatter %alloc_5[16, 1, #map6] onto %15 : memref<1x1x1xf32> onto !upmem.hierarchy<1x6x16>
    upmem.scatter %2[0, 3, #map3] onto %15 : memref<96x3xf32> onto !upmem.hierarchy<1x6x16>
    upmem.launch_func  @dpu_kernels::@attn_9 %15 : !upmem.hierarchy<1x6x16> 
    %alloc_6 = memref.alloc() {alignment = 64 : i64} : memref<96x3xf32>
    upmem.gather %alloc_6[0, 3, #map3] from %15 : memref<96x3xf32> from !upmem.hierarchy<1x6x16>
    %reshape_7 = memref.reshape %alloc_6(%3) : (memref<96x3xf32>, memref<1xi64>) -> memref<288xf32>
    upmem.free_dpus %15 : !upmem.hierarchy<1x6x16>
    %16 = upmem.alloc_dpus : !upmem.hierarchy<1x6x16>
    %reshape_8 = memref.reshape %reshape_7(%1) : (memref<288xf32>, memref<2xi64>) -> memref<96x3xf32>
    upmem.scatter %reshape_8[32, 3, #map3] onto %16 : memref<96x3xf32> onto !upmem.hierarchy<1x6x16>
    %reshape_9 = memref.reshape %arg1(%1) : (memref<288xf32>, memref<2xi64>) -> memref<96x3xf32>
    upmem.scatter %reshape_9[16, 3, #map3] onto %16 : memref<96x3xf32> onto !upmem.hierarchy<1x6x16>
    upmem.scatter %2[0, 3, #map3] onto %16 : memref<96x3xf32> onto !upmem.hierarchy<1x6x16>
    upmem.launch_func  @dpu_kernels::@attn %16 : !upmem.hierarchy<1x6x16> 
    %alloc_10 = memref.alloc() {alignment = 64 : i64} : memref<96x3xf32>
    upmem.gather %alloc_10[0, 3, #map3] from %16 : memref<96x3xf32> from !upmem.hierarchy<1x6x16>
    %reshape_11 = memref.reshape %alloc_10(%3) : (memref<96x3xf32>, memref<1xi64>) -> memref<288xf32>
    upmem.free_dpus %16 : !upmem.hierarchy<1x6x16>
  ...
  func.func @softmax(%arg0: memref<256xf32>) -> memref<256xf32> {
    ...
    %c256 = arith.constant 256 : index
    %c0 = arith.constant 0 : index
    %0 = memref.get_global @__constant_xf32_0 : memref<f32>
    ...
    %6 = upmem.alloc_dpus : !upmem.hierarchy<1x8x16>
    %7 = memref.get_global @__constant_2xi64_0 : memref<2xi64>
    %reshape = memref.reshape %arg0(%7) : (memref<256xf32>, memref<2xi64>) -> memref<128x2xf32>
    upmem.scatter %reshape[16, 2, #map3] onto %6 : memref<128x2xf32> onto !upmem.hierarchy<1x8x16>
    %alloc_2 = memref.alloc() {alignment = 64 : i64} : memref<1x1x1xf32>
    memref.store %5, %alloc_2[%c0, %c0, %c0] : memref<1x1x1xf32>
    upmem.scatter %alloc_2[8, 1, #map6] onto %6 : memref<1x1x1xf32> onto !upmem.hierarchy<1x8x16>
    %8 = memref.get_global @__constant_128x2xf32 : memref<128x2xf32>
    upmem.scatter %8[0, 2, #map3] onto %6 : memref<128x2xf32> onto !upmem.hierarchy<1x8x16>
    upmem.launch_func  @dpu_kernels::@softmax %6 : !upmem.hierarchy<1x8x16> 
    %alloc_3 = memref.alloc() {alignment = 64 : i64} : memref<128x2xf32>
    upmem.gather %alloc_3[0, 2, #map3] from %6 : memref<128x2xf32> from !upmem.hierarchy<1x8x16>
    ...
    %10 = memref.get_global @__constant_xf32 : memref<f32>
    ...
    upmem.scatter %reshape_9[16, 2, #map3] onto %16 : memref<128x2xf32> onto !upmem.hierarchy<1x8x16>
    %alloc_10 = memref.alloc() {alignment = 64 : i64} : memref<1x1x1xf32>
    memref.store %15, %alloc_10[%c0, %c0, %c0] : memref<1x1x1xf32>
    upmem.scatter %alloc_10[8, 1, #map6] onto %16 : memref<1x1x1xf32> onto !upmem.hierarchy<1x8x16>
    upmem.scatter %8[0, 2, #map3] onto %16 : memref<128x2xf32> onto !upmem.hierarchy<1x8x16>
    ...
    upmem.gather %alloc_11[0, 2, #map3] from %16 : memref<128x2xf32> from !upmem.hierarchy<1x8x16>
  ...
  upmem.module @dpu_kernels {
    upmem.func @forward() attributes {num_tasklets = 8 : i64} {
      ...
      %c288 = arith.constant 288 : index
      %1 = upmem.pwram_alloc : memref<288xf32>
      %c2304 = arith.constant 2304 : index
      %2 = arith.addi %0, %c2304 : index
      %3 = upmem.pwram_alloc : memref<288xf32>
      %4 = arith.addi %2, %c2304 : index
      %c1 = arith.constant 1 : index
      %5 = upmem.pwram_alloc : memref<f32>
      upmem.memcpy  mram_to_wram %1, %c288, %0 : memref<288xf32>, index, index
      upmem.memcpy  mram_to_wram %3, %c288, %2 : memref<288xf32>, index, index
      %c0 = arith.constant 0 : index
      scf.for %arg0 = %c0 to %c288 step %c1 {
        %6 = memref.load %1[%arg0] : memref<288xf32>
        %7 = memref.load %3[%arg0] : memref<288xf32>
        %8 = memref.load %5[] : memref<f32>
        %9 = arith.mulf %6, %7 : f32
        %10 = arith.addf %9, %8 : f32
        memref.store %10, %5[] : memref<f32>
      }
      upmem.memcpy  wram_to_mram %5, %c1, %4 : memref<f32>, index, index
      upmem.return
    }
    upmem.func @forward_3() attributes {num_tasklets = 8 : i64} {
      %0 = upmem.dpu_heap_base_addr : index
      %c6 = arith.constant 6 : index
      %1 = upmem.pwram_alloc : memref<6xf32>
      %c48 = arith.constant 48 : index
      %2 = arith.addi %0, %c48 : index
      %3 = upmem.pwram_alloc : memref<6xf32>
      %4 = arith.addi %2, %c48 : index
      %5 = upmem.pwram_alloc : memref<6xf32>
      upmem.memcpy  mram_to_wram %1, %c6, %0 : memref<6xf32>, index, index
      upmem.memcpy  mram_to_wram %3, %c6, %2 : memref<6xf32>, index, index
      %c0 = arith.constant 0 : index
      %c1 = arith.constant 1 : index
      scf.for %arg0 = %c0 to %c6 step %c1 {
        %6 = memref.load %1[%arg0] : memref<6xf32>
        %7 = memref.load %3[%arg0] : memref<6xf32>
        %8 = arith.addf %6, %7 : f32
        memref.store %8, %5[%arg0] : memref<6xf32>
      }
      upmem.memcpy  wram_to_mram %5, %c6, %4 : memref<6xf32>, index, index
      upmem.return
    }
    upmem.func @forward_6() attributes {num_tasklets = 8 : i64} {
      %0 = upmem.dpu_heap_base_addr : index
      %c768 = arith.constant 768 : index
      %1 = upmem.pwram_alloc : memref<768xf32>
      %c6144 = arith.constant 6144 : index
      %2 = arith.addi %0, %c6144 : index
      %3 = upmem.pwram_alloc : memref<768xf32>
      %4 = arith.addi %2, %c6144 : index
      %c1 = arith.constant 1 : index
      %5 = upmem.pwram_alloc : memref<f32>
      upmem.memcpy  mram_to_wram %1, %c768, %0 : memref<768xf32>, index, index
      upmem.memcpy  mram_to_wram %3, %c768, %2 : memref<768xf32>, index, index
      %c0 = arith.constant 0 : index
      scf.for %arg0 = %c0 to %c768 step %c1 {
        %6 = memref.load %1[%arg0] : memref<768xf32>
        %7 = memref.load %3[%arg0] : memref<768xf32>
        %8 = memref.load %5[] : memref<f32>
        %9 = arith.mulf %6, %7 : f32
        %10 = arith.addf %9, %8 : f32
        memref.store %10, %5[] : memref<f32>
    ...
    upmem.func @forward_8() attributes {num_tasklets = 16 : i64} {
      ...
      %2 = arith.addi %0, %c4608 : index
      %3 = upmem.pwram_alloc : memref<288xf32>
      %4 = arith.addi %2, %c4608 : index
      %c1 = arith.constant 1 : index
      %5 = upmem.pwram_alloc : memref<f32>
      upmem.memcpy  mram_to_wram %1, %c288, %0 : memref<288xf32>, index, index
      upmem.memcpy  mram_to_wram %3, %c288, %2 : memref<288xf32>, index, index
    ...
    upmem.func @attn() attributes {num_tasklets = 16 : i64} {
      %0 = upmem.dpu_heap_base_addr : index
      %c3 = arith.constant 3 : index
      %1 = upmem.pwram_alloc : memref<3xf32>
      %c48 = arith.constant 48 : index
      %2 = arith.addi %0, %c48 : index
      %3 = upmem.pwram_alloc : memref<3xf32>
      %4 = arith.addi %2, %c48 : index
      %5 = upmem.pwram_alloc : memref<3xf32>
      upmem.memcpy  mram_to_wram %1, %c3, %0 : memref<3xf32>, index, index
      upmem.memcpy  mram_to_wram %3, %c3, %2 : memref<3xf32>, index, index
      %c0 = arith.constant 0 : index
      %c1 = arith.constant 1 : index
      scf.for %arg0 = %c0 to %c3 step %c1 {
        %6 = memref.load %1[%arg0] : memref<3xf32>
        %7 = memref.load %3[%arg0] : memref<3xf32>
        %8 = arith.mulf %6, %7 : f32
        memref.store %8, %5[%arg0] : memref<3xf32>
      }
      upmem.memcpy  wram_to_mram %5, %c3, %4 : memref<3xf32>, index, index
      upmem.return
    }
    upmem.func @attn_9() attributes {num_tasklets = 16 : i64} {
      %0 = upmem.dpu_heap_base_addr : index
      %c3 = arith.constant 3 : index
      %1 = upmem.pwram_alloc : memref<3xf32>
      %c48 = arith.constant 48 : index
      %2 = arith.addi %0, %c48 : index
      %c1 = arith.constant 1 : index
      %3 = upmem.pwram_alloc : memref<f32>
      %c16 = arith.constant 16 : index
      %4 = arith.addi %2, %c16 : index
      %5 = upmem.pwram_alloc : memref<3xf32>
      upmem.memcpy  mram_to_wram %1, %c3, %0 : memref<3xf32>, index, index
      upmem.memcpy  mram_to_wram %3, %c1, %2 : memref<f32>, index, index
      %c0 = arith.constant 0 : index
      scf.for %arg0 = %c0 to %c3 step %c1 {
        %6 = memref.load %1[%arg0] : memref<3xf32>
        %7 = memref.load %3[] : memref<f32>
        %8 = arith.mulf %6, %7 : f32
        memref.store %8, %5[%arg0] : memref<3xf32>
      }
      upmem.memcpy  wram_to_mram %5, %c3, %4 : memref<3xf32>, index, index
    ...
    upmem.func @attn_10() attributes {num_tasklets = 16 : i64} {
      %0 = upmem.dpu_heap_base_addr : index
      %c3 = arith.constant 3 : index
      %1 = upmem.pwram_alloc : memref<3xf32>
      %c48 = arith.constant 48 : index
    ...
    upmem.func @softmax() attributes {num_tasklets = 16 : i64} {
      %0 = upmem.dpu_heap_base_addr : index
      %c2 = arith.constant 2 : index
      %1 = upmem.pwram_alloc : memref<2xf32>
      %c32 = arith.constant 32 : index
      %2 = arith.addi %0, %c32 : index
      %c1 = arith.constant 1 : index
      %3 = upmem.pwram_alloc : memref<f32>
      %c16 = arith.constant 16 : index
      %4 = arith.addi %2, %c16 : index
      %5 = upmem.pwram_alloc : memref<2xf32>
      upmem.memcpy  mram_to_wram %1, %c2, %0 : memref<2xf32>, index, index
      upmem.memcpy  mram_to_wram %3, %c1, %2 : memref<f32>, index, index
      %c0 = arith.constant 0 : index
      scf.for %arg0 = %c0 to %c2 step %c1 {
        %6 = memref.load %1[%arg0] : memref<2xf32>
        %7 = memref.load %3[] : memref<f32>
        %8 = arith.subf %6, %7 : f32
        memref.store %8, %5[%arg0] : memref<2xf32>
      }
      upmem.memcpy  wram_to_mram %5, %c2, %4 : memref<2xf32>, index, index
      upmem.return
    }
